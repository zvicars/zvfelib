...
static inline void makeHistogramWeighted(const std::vector<double>& data, const std::vector<double>& weights, double min_bin_, double max_bin_, double bin_size_, bool forceMin, bool forceMax, bool forceBS,
